  ...
  $.fn.slider = function (options) {
    return this
      .each(function () {
        ...
        var markup; // the markup that will be loaded in the DOM to facade the input range.

        if(this._options.stepper === true && this._options.progress === false) {
          markup = '' +
            '<div>' +
        ...
        else if(this._options.stepper === false && this._options.progress === false) {
          markup = '' +
            '<div>' +
              '<div class="center">' +
                '<div class="content">' +
        ...
        else if(this._options.stepper === false && this._options.progress === true) {
          markup = '' +
            '<div>' +
              '<div class="center">' +
                '<div class="content">' +
        ...
        var updateThumbPosition = function () {
          ...
          if(_plugin._options.progress === true) {
            var newWidth = (trackWidth / value.max) * value.current;
            $target.find('.track').width(newWidth + 'px');
          }
        };
